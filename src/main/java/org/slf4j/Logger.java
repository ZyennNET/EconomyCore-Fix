...
public interface Logger {
   ...
   default LoggingEventBuilder makeLoggingEventBuilder(Level var1) {
      return new DefaultLoggingEventBuilder(this, var1);
   }

   @CheckReturnValue
   default LoggingEventBuilder atLevel(Level var1) {
      return this.isEnabledForLevel(var1) ? this.makeLoggingEventBuilder(var1) : NOPLoggingEventBuilder.singleton();
   }

   default boolean isEnabledForLevel(Level var1) {
      int var2 = var1.toInt();
      switch (var2) {
         case 0:
         ...
         default:
            throw new IllegalArgumentException("Level [" + var1 + "] not recognized.");
      }
   }
