...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
   ...
   public <T> TypeAdapter<T> create(Gson var1, TypeToken<T> var2) {
      ...
      if (!Map.class.isAssignableFrom(var4)) {
         ...
         Adapter var9 = new Adapter(var1, var5[0], var6, var5[1], var7, var8);
         return var9;
      }
   }
   ...
   private final class Adapter<K, V> extends TypeAdapter<Map<K, V>> {
      ...
      public Adapter(Gson var2, Type var3, TypeAdapter<K> var4, Type var5, TypeAdapter<V> var6, ObjectConstructor<? extends Map<K, V>> var7) {
         this.keyTypeAdapter = new TypeAdapterRuntimeTypeWrapper<K>(var2, var4, var3);
         this.valueTypeAdapter = new TypeAdapterRuntimeTypeWrapper<V>(var2, var6, var5);
