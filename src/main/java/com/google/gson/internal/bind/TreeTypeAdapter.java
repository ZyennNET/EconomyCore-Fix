...
public final class TreeTypeAdapter<T> extends SerializationDelegatingTypeAdapter<T> {
   ...
   public T read(JsonReader var1) throws IOException {
      if (this.deserializer == null) {
         ...
         return (T)(this.nullSafe && var2.isJsonNull() ? null : this.deserializer.deserialize(var2, this.typeToken.getType(), this.context));
      }
   }
   ...
   private TypeAdapter<T> delegate() {
      ...
      return var1 != null ? var1 : (this.delegate = this.gson.<T>getDelegateAdapter(this.skipPastForGetDelegateAdapter, this.typeToken));
   }
   ...
   private final class GsonContextImpl implements JsonSerializationContext, JsonDeserializationContext {
      ...
      public <R> R deserialize(JsonElement var1, Type var2) throws JsonParseException {
         return (R)TreeTypeAdapter.this.gson.fromJson(var1, var2);
      }
   }
